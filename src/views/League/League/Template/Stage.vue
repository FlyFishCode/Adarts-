  ...
  <div>
    <div class="box">
      ...
      <el-row class="center-Row">
        ...
        <el-col :span="20">
          <el-input v-model="stage.description" type="textarea" :autosize="{ minRows: 4, maxRows: 4 }" :show-word-limit="showLimit" clearable maxlength="100" :placeholder="$t('placeholder.input')"></el-input>
        </el-col>
      </el-row>
      <el-row class="center-Row">
        <el-col class="label-g" :span="4">
        ...
        <el-col :span="8">
          <el-col :span="11">
            <el-date-picker v-model="stage.startTime" type="datetime" format="yyyy-MM-dd HH:mm:ss" default-time="00:00:00" :clearable='false' :placeholder="$t('placeholder.datePicker')"></el-date-picker>
          </el-col>
          <el-col :span="1" class="lineClass">-</el-col>
          <el-col :span="11">
            <el-date-picker v-model="stage.endTime" type="datetime" format="yyyy-MM-dd HH:mm:ss" default-time="23:59:59" :clearable='false' :placeholder="$t('placeholder.datePicker')" :picker-options="pickerOptions"  @change="dateChange"></el-date-picker>
          </el-col>
        </el-col>
      </el-row>
    </div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      parityPlayList: [
        { value: 1, label: 'all.tip87' },
        { value: 2, label: 'all.tip86' }
      ],
      choiceList: [
        { value: 1, label: 'all.tip87' },
        { value: 2, label: 'all.tip86' }
      ...
      gameTypeList: [
        { value: 1, label: 'all.tip395' },
        { value: 2, label: 'all.tip494' },
        { value: 3, label: 'all.tip495' },
        { value: 4, label: 'all.tip496' }
      ],
      gameNameList: [
  ...
  methods: {
    ...
    Save() {
      ...
      const saveMethods = () => {
        this.$axios.post(`/${url}`, vm.stage).then(res => {
          if (res.data.data) {
            const stage = 'stageId';
            let item = {};
            let type = '';
      ...
      // 如果比賽已經開打，需確認是否修改
      if (url === 'updatestage' && vm.numFight) {
